...
//             <div className='h-5 md:h-12 w-[95%] sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] bg-white rounded-lg mt-12 px-2 md:px-6 flex items-center justify-between'>
...
//                 variant="default" 
//                 size={"lg"} className='mr-2'>Create</Button>
//             </div>
